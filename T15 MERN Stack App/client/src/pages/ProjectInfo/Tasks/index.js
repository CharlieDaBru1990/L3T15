...
// The Tasks component is a functional component that imports various dependencies and hooks.
// It defines state variables, such as filters, showViewTask, tasks, showTaskForm, and task,
// using the useState hook. It also uses the useSelector and useDispatch hooks
// from Redux to access and dispatch actions to the Redux store.

// The component defines several helper functions, such as getTasks, deleteTask, and onStatusUpdate,
// which handle API calls and state updates. It also includes an useEffect hook to fetch tasks when
// the component mounts or when the filters state changes.

// The component renders a UI consisting of buttons, selects, and a table using the Ant Design components.
// It conditionally renders the TaskForm and Modal components based on user interactions.
