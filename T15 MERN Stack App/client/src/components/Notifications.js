...
// Define helper functions for marking notifications as read and deleting all notifications.
// Use the useEffect hook to mark notifications as read when the component mounts.
// Render the modal window and the list of notifications.
